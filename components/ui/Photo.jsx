  ...
  return <div className="w-full h-full relative">
    <motion.div initial={{ opacity: 0 }} animate={{
      ...
      <motion.div
        ...
        className="w-[100px] h-[100px] xl:w-[230px] xl:h-[230px] mix-blend-lighten absolute">
        <Image
          src="/assets/Rushi1.png"
          priority
          quality={100}
          fill
          alt="Image Error"
      ...
      {/* circle  */}
      <motion.svg className="w-150px] xl:w-[356px] h-[150px] xl:h-[356px]"
        fill="transparent"
        viewBox="0 0 506 506"
